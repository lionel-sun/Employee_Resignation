...
train_x = train_data.drop(columns=['user_id', 'Attrition', 'EmployeeNumber', 'Over18', 'EmployeeCount', 'StandardHours',
                                   'Education', 'HourlyRate'])
test_data = pd.read_csv('test.csv')
test_x = test_data.drop(columns=['user_id', 'EmployeeNumber', 'Over18', 'EmployeeCount', 'StandardHours', 'Education',
                                 'HourlyRate'])
# 数据探索
...
for i in range(len(feature_importance)):
    print(dvec.feature_names_[i]+":"+str(feature_importance[i]))
